...
namespace TPLPLM.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public async Task<JsonResult> OnPostValidateCredentials([FromBody] LoginRequest model)
        {
            ...
            bool authorized = roles.Contains("Admin") || roles.Contains("Supervisor");

            return new JsonResult(new
            {
                success = authorized,
                message = authorized ? "Authorized" : "Insufficient privileges"
            });
        }
