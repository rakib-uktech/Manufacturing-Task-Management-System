...
{
    [Authorize]
    public class Clear_WasteListModel : PageModel
    {
        ...
        public Clear_WasteListModel(IConfiguration configuration)
        {
        ...
        public void OnGet()
        {
            try
            {
                ...
                using (NpgsqlConnection connection = new NpgsqlConnection(DefaultConnection))
                {
                    ...
                    string sql = "SELECT * from task_manager Where task_type='Clear Waste' and status='A'";
