...
namespace TPL_TM.Pages
{
    ...
    public class Management_DashboardModel : PageModel
    {
        private readonly IConfiguration _configuration;
        public string errorMessage = "";
        private readonly UserManager<IdentityUser> _userManager;
        private readonly ManufacturingAIService _aiService;

        public Management_DashboardModel(
            IConfiguration configuration,
            UserManager<IdentityUser> userManager,
            ManufacturingAIService aiService)
        {
        ...
        public async Task<IActionResult> OnGetAskAIAsync(string question)
        {
            var answer = await _aiService.Ask(question);
