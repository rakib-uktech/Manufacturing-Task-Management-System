...
{
    [Authorize]
    public class Move_ItemListModel : PageModel
    {
        ...
        public Move_ItemListModel(IConfiguration configuration)
        {
        ...
        public void OnGet()
        {
            try
            {
                ...
                using (NpgsqlConnection connection = new NpgsqlConnection(DefaultConnection))
                {
                    ...
                    string sql = "SELECT * from task_manager Where task_type='Move Item' and status='A'";
